...
> 预览、目录选择和明确确认后才写入的脱敏本地诊断包；R10D 安装升级和 R10E 候选验证尚未开始。
...
| **R10**    | **安装、升级、备份恢复、诊断和 Windows 端到端验收**   | **R10B 已合并；R10C 提供受控本地诊断，R10D—R10E 待独立授权** |
...
R10C 提供受控本地脱敏诊断导出；R10D Windows 安装/升级/卸载和 R10E Release Candidate 尚未开始，均等待独立决策与授权。
