...
> R10A 与 R10B1A—R10B1C 已进入 `main`；R10B 完整受控备份与恢复已通过 PR #26 合并到 `main`，诊断、安装升级和
> 候选验证尚未开始实施。
...
| **R10**    | **安装、升级、备份恢复、诊断和 Windows 端到端验收**   | **R10B 已通过 PR #26 合并；R10C—R10E 待独立授权** |
...
<p align="center">
  ...
  <br />
  V2-R01—R09 已验收并合并；R10B 的完整恢复已通过 PR #26 合并，R10C—R10E 与后续发布准备仍待独立授权；最终发布和互动发送始终由用户手动完成。
</p>
