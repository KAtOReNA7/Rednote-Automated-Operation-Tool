<p align="center">
  ...
  <img alt="V2 R05 acceptance pending" src="https://img.shields.io/badge/V2--R05-等待用户验收-ff8a00" />
  <img alt="Next user acceptance" src="https://img.shields.io/badge/下一步-R05%20体验验收-ff8a00" />
...
| **做到哪一步？**             | V2-R04 已验收；V2-R05 已实现评论/私信本地导入、Scripted 建议、版本状态与墓碑删除，等待用户体验验收 |
| **下一步是什么？**           | 用户亲自验证 R05 Windows 体验包；明确接受前不合并，也不进入 R06                                    |
...
> 改写 Draft、创建审批、导出或发布。独立 V2 路线当前已到 R05：R04 提供本地内容包与受控目录导出；
