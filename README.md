<p align="center">
  ...
  <img alt="Issues 001–019 completed" src="https://img.shields.io/badge/已完成-Issues%20001--019-2ea44f" />
  <img alt="Next Issue 020" src="https://img.shields.io/badge/下一步-Issue%20020-ff2442" />
...
| **做到哪一步？**             | M0、M1 已完成；M2 已完成 Issue 012–019                                          |
| **下一步是什么？**           | Issue 020（研究档案，仅规划；本轮未开始）                                       |
...
> [!TIP]
> 里程碑快照：M1（Issue 006—011）与 M2 Issue 012—019 均已完成验收；下一步仅规划
> Issue 020。浏览器插件只在用户点击后收藏当前公开页面的有限样本；候选固定为
...
flowchart LR
    ...
    M2 --> NEXT["NEXT<br/>Issue 020<br/>研究档案，仅规划"]
...
| M2     |    012–021 | 模型接口、搜索、书库与研究             | **进行中 · 8/10** |
...
| SQLite 连续迁移、备份、回滚、外键、STRICT 表与 WAL                        | Issue 020 的可版本化研究档案                              |
| 支持暂停、取消、租约和重启恢复的持久化任务队列                            | Issue 020 的可版本化研究档案                              |
...
| Source revision、AtomicClaim、精确 EvidenceLocator、FactPolicy 与冲突审计 | 研究档案覆盖度与增量重建                                  |
