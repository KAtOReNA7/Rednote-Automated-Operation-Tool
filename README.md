...
| **做到哪一步？**             | M0、M1、M2 已完成；M3 已交付事实映射、合成最小闭环与可观测验证收口              |
...
> Issue 027。普通测试与容量测试现使用静态零重叠集合；长任务会持久记录 stdout/stderr、结构化结果、
...
<p align="center">
  ...
  <br />
  M3 Issue 022–026、合成最小闭环与验证可靠性收口已完成；Issue 027 仅规划，尚未开始。
</p>
