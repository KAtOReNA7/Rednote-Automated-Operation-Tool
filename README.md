...
> 预览、目录选择和明确确认后才写入的脱敏本地诊断包；R10D 的未签名、每用户离线安装、手动升级与保留数据卸载已经
> PR #29 和合并后 `main` Windows CI 验证。R10E 正在建立 Draft Release Candidate，Windows 10/11 人工验收均未运行。
...
| **R10**    | **安装、升级、备份恢复、诊断和 Windows 端到端验收**   | **R10B—R10D 已进入 main；R10E 候选待 Win10/11 人工验收** |
...
R10C 提供受控本地脱敏诊断导出；R10D Windows 每用户离线安装、手动升级与保留数据卸载已通过 PR #29 精确 HEAD 和合并后 `main` Windows CI；R10E 只准备可审计 Draft Release Candidate，仍须 Windows 10/11 两个平台分别人工验收。
...
- [R10E Windows 内部 Beta 用户指南](./docs/user-guide/windows-beta-user-guide.md)
- [R10E Windows 10/11 人工验收清单](./docs/reviews/R10E-windows-10-11-user-acceptance.md)
...
<p align="center">
  ...
  <br />
  V2-R01—R09 已验收并合并；R10B 的完整恢复已通过 PR #26 合并，R10C 提供受控本地诊断，R10D 已通过 PR #29 和主线 CI；R10E 仍等待 Win10/11 人工验收，最终发布和互动发送始终由用户手动完成。
</p>
