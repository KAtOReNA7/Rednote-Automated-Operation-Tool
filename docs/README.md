...
Issue 022 的 Topic Pool 与 First-30 配额，以及 Issue 023 的版本化单变量实验与确定性分配；
本地证据分别见
[`evidence/m3-issue022-local-evidence.md`](./evidence/m3-issue022-local-evidence.md) 和
[`evidence/m3-issue023-local-evidence.md`](./evidence/m3-issue023-local-evidence.md)。下一项仅规划
Issue 024，未收到明确任务时不自动开始。
