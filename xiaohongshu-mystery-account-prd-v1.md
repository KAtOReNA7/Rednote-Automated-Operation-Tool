...
用户不提供首批 50 本书单。系统必须自行完成书目发现、基础资料整理和去重。
...
| M2 研究系统 | 搜索适配器、书库、来源、事实声明、插件 | 空书库形成 50 本候选 |
...
| 4.不能提供书单 | 系统必须从空书库自行发现至少 50 本书 | 2.3、7.3、FR-02 |
