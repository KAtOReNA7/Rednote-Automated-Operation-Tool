...
describe('managed local path migration', () => {
  ...
  it('distinguishes managed file paths from domain field-path identifiers', async () => {
    ...
    try {
      ...
      expect(rows).toEqual([
        ...
        { column_name: 'field_path', table_name: 'content_draft_field_states' },
        { column_name: 'brief_field_path', table_name: 'content_draft_lineage_refs' },
        ...
        {
          column_name: 'generated_cover_path',
          table_name: 'v2_content_package_versions',
        },
