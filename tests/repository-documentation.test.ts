...
describe('repository-facing documentation', () => {
  it('reports completed Issue 017 and keeps Issue 018 as the bounded next milestone', () => {
    expect(readme).toContain('M1（Issue 006—011）');
    expect(readme).toContain('M2 Issue 012—017 均已完成验收');
    expect(readme).toContain('Issue 018（仅规划；本轮未开始）');
    expect(readme).toContain('Chrome / Edge MV3');
    ...
    expect(readme).toContain('外部请求数为 0');
