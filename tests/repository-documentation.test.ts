...
describe('repository-facing documentation', () => {
  it('reports the completed Issue 014 foundation and the bounded next milestone', () => {
    expect(readme).toContain('M1（Issue 006—011）');
    expect(readme).toContain('M2 Issue 012—014 均已完成验收');
    expect(readme).toContain('Issue 015：通用 SearchProvider');
